...
{
    public partial class add_continuous_learning : System.Web.UI.Page
    {
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            else
            {
                ...
                if (action == "edit")
                {
                    ...
                    var res = dc.CMSGetContinuousEducationByID(id).Single();
        ...
        protected void savebtn_Click(object sender, EventArgs e)
        {
            ...
            if (action == "edit")
            {
                ...
                if (photo.HasFile && Request["hasphoto"] == "on")
                {
                    ...
                    ifn = res.thumb;
                dc.UpdateContinuousEducation(id, Request.Form["arname"], Request.Form["enname"], Request.Form["frname"], Request.Form["ardesc"], Request.Form["endesc"], Request.Form["frdesc"],int.Parse(Request["status"]), ifn);
            }
            else
            {
                string ifn = "";
                ...
                dc.AddContinuousEducation(Request.Form["arname"], Request.Form["enname"], Request.Form["frname"], Request.Form["ardesc"], Request.Form["endesc"], Request.Form["frdesc"], int.Parse(Request["status"]), ifn);
            }
            Response.Redirect("continuous-learning.aspx");
        }
