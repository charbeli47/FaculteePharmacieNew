<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="add-education.aspx.cs" Inherits="FacultyOfPharmacy.cms.add_education" %>
...
<center>
    ...
    <table>
    <tr><td>Code</td><td><asp:TextBox ID="code" runat="server" /></td></tr>
    <tr><td>Title</td><td><asp:TextBox ID="title" runat="server" /></td></tr>
    <tr><td>Total/h</td><td><asp:TextBox ID="total_hours" runat="server" /></td></tr>
    <tr><td>Theory</td><td><asp:TextBox ID="theory" runat="server" /></td></tr>
    <tr><td>TD</td><td><asp:TextBox ID="td" runat="server" /></td></tr>
    <tr><td>TP</td><td><asp:TextBox ID="tp" runat="server" /></td></tr>
    <tr><td>Credits</td><td><asp:TextBox ID="credits" runat="server" /></td></tr>
    <tr><td>Pre Requisits</td><td><asp:TextBox ID="pre_req" TextMode="MultiLine" runat="server" /></td></tr>
