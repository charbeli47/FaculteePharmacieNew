        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            else
            {
                ...
                if (action == "edit")
                {
                    ...
                    var res = dc.CMSGetEventsByID(id).Single();
        ...
        protected void savebtn_Click(object sender, EventArgs e)
        {
            ...
            if (action == "edit")
            {
                ...
                if (photo.HasFile && Request["hasphoto"] == "on")
                {
                    ...
                    ifn = res.photo;
                dc.UpdateEvents(id, Request.Form["artitle"],Request.Form["entitle"],Request.Form["frtitle"],Request.Form["artext"],Request.Form["entext"],Request.Form["frtext"],Request["date_start"]!="" ? DateTime.Parse(Request["date_start"]):new DateTime?(),Request["date_end"]!=""?DateTime.Parse(Request["date_end"]): new DateTime?(), ifn, Request["Organizer"]);
            }
            else
            {
                string ifn = "";
                ...
                dc.AddEvents(Request.Form["artitle"], Request.Form["entitle"], Request.Form["frtitle"], Request.Form["artext"], Request.Form["entext"], Request.Form["frtext"], Request["date_start"] != "" ? DateTime.Parse(Request["date_start"]) : new DateTime?(), Request["date_end"] != "" ? DateTime.Parse(Request["date_end"]) : new DateTime?(), ifn, Request["Organizer"]);
            }
