<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="add-official-statement.aspx.cs" Inherits="FacultyOfPharmacy.cms.add_official_statement" %>
...
<center>
    ...
    <table>
    <tr><td>Title</td><td><asp:TextBox ID="title" style="width:300px" runat="server" /></td></tr>
    <tr><td>Description</td><td><asp:TextBox ID="desc" TextMode="MultiLine" style="width:300px; height:100px" runat="server" /></td></tr>
    <tr><td>Has File</td><td><asp:CheckBox ID="hasfile" runat="server" /></td></tr>
    <tr><td>File</td><td><asp:FileUpload ID="file" runat="server" /><a id="fileView" runat="server"  target="_blank" >View File</a></td></tr>
    <tr><td></td></tr>
