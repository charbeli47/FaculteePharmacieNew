        ...
        protected void savebtn_Click(object sender, EventArgs e)
        {
            ...
            if (action == "edit")
            {
                ...
                if (photo.HasFile && Request["hasphoto"] == "on")
                {
                    ...
                    ifn = res.photo;
                dc.UpdateActivities(id, Request.Form["artitle"],Request.Form["entitle"],Request.Form["frtitle"],Request.Form["artext"],Request.Form["entext"],Request.Form["frtext"], ifn);
            }
            else
            {
                string ifn = "";
                ...
                dc.AddActivities(Request.Form["artitle"], Request.Form["entitle"], Request.Form["frtitle"], Request.Form["artext"], Request.Form["entext"], Request.Form["frtext"], ifn);
            }
