<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="add-department.aspx.cs" Inherits="FacultyOfPharmacy.cms.add_department" %>
...
<center>
    ...
    <tr><td>Arabic description</td><td><asp:TextBox TextMode="MultiLine" ID="ardesc" style="width:300px; height:100px" runat="server" /></td></tr>
    <tr><td>French description</td><td><asp:TextBox TextMode="MultiLine" ID="frdesc" style="width:300px; height:100px" runat="server" /></td></tr>
    <tr><td>english description</td><td><asp:TextBox TextMode="MultiLine" ID="endesc" style="width:300px; height:100px" runat="server" /></td></tr>
