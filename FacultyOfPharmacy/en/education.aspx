<%@ Page Title="" Language="C#" MasterPageFile="~/en/en.master" AutoEventWireup="true" CodeBehind="education.aspx.cs" Inherits="FacultyOfPharmacy.en.education" %>
...
<Columns>
    <asp:BoundField HeaderText="Cours" DataField="title" SortExpression="title" ItemStyle-HorizontalAlign="Left" ItemStyle-Width="300"/>
<asp:BoundField HeaderText="Credits" DataField="credits" SortExpression="credits" ItemStyle-HorizontalAlign="Center"/>
<asp:BoundField HeaderText="Description" DataField="description" SortExpression="description" ItemStyle-HorizontalAlign="Left" ItemStyle-Width="300"/>
</Columns>
</asp:GridView>
</p></form></div>
                </div>
