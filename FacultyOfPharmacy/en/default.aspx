<%@ Page Title="" Language="C#" MasterPageFile="~/en/en.master" AutoEventWireup="true" CodeBehind="default.aspx.cs" Inherits="FacultyOfPharmacy.en._default" %>
				...
				<div class="container">
					...
					<div class="row">
						...
						<div class="grid_3">
							...
							<div class="box-1">
								<h2 class="marTop0">About Us</h2>
								<p class="marTop3"><asp:Literal ID="aboutTxt" runat="server" /></p>
								<a href="history.aspx" class="more_btn">Read more</a>
							</div>
						</div>
						...
						<div class="grid_6">
                            ...
                            <%foreach(var n in news){
                                  ...
                                  if (weeks <= 1)
                                  {
                                      weeksResponse = ((int)(DateTime.Now - n.date_in.Value).TotalDays).ToString() + " days ago";
                                  }
                                  else
                                  {
                                      weeksResponse = weeks + " weeks ago";
                                  } %>
							<div class="hline2">
								<p class="txt4"><%= weeksResponse%> </p>
								<p class="txt5"><a href="news-details.aspx?id=<%=n.id %>" class="link2"><%= n.entitle %></a></p>
								<%--<div class="wrapper">
							...
							<p class="txt7"><a href="news.aspx">See all</a></p>
                            <%}
                              else{ %>
						...
						<div class="grid_3">
                            ...
                            <%if(events.Count>0){foreach(var e in events)
                              {  %>
							<a href="event-details.aspx?id=<%=e.id %>" class="link_img">
								<div class="img_section">
									<img src="../Media/<%=e.photo %>" alt="">
									<div class="img_section_txt">
										<p class="txt8"><%=string.Format("{0}",e.date_start) %>  -  8:00 AM</p>
										<p class="txt9"><%=e.entitle %> </p>
									</div>
								</div>
							</a>
                            <%} %>
                            ...
                            <%}else{ %>
                            <p>Stay tuned for the Upcoming events</p>
                            <%} %>
						</div>
