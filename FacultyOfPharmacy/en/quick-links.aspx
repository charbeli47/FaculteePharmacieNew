<%@ Page Title="Quick Links" Language="C#" MasterPageFile="~/en/en.master" AutoEventWireup="true" CodeBehind="quick-links.aspx.cs" Inherits="FacultyOfPharmacy.en.quick_links" %>
<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="server">
</asp:Content>
<asp:Content ID="Content2" ContentPlaceHolderID="main" runat="server">
    <div class="container">
					<h2 class="marTop4">Quick Links</h2>
